...
namespace cheonsa
{
	...
	void_c menu_control_scroll_c::_on_mouse_focus_gained()
	{
	...
	void_c menu_control_scroll_c::_on_mouse_focus_lost()
	{
	...
	void_c menu_control_scroll_c::_on_input( input_event_c * input_event )
	{
	...
	void_c menu_control_scroll_c::update_transform_and_layout()
	{
	...
	menu_control_scroll_c::menu_control_scroll_c()
		: menu_control_c()
		, _rail_element()
		, _grip_element()
		, _orientation( orientation_e_vertical )
		...
		, _fixed_thickness( 10.0f )
		, _fixed_grip_length( 10.0f )
		, _dynamic_grip_length( 10.0f )
		, _dynamic_grip_position( 0.0f )
		, _mouse_grab( false )
		, _mouse_grab_offset( 0.0f )
	{
	...
	/*
	void_c menu_control_scroll_c::load_properties( data_scribe_markup_c const * mark_up, data_scribe_markup_c::node_c const * node )
	{
	...
	*/
	...
	void_c menu_control_scroll_c::update_animations( float32_c time_step )
	{
		if ( _mode == mode_e_scroller )
		{
	...
	void_c menu_control_scroll_c::load_properties( data_scribe_markup_c::node_c const * node )
	{
		menu_control_c::load_properties( node );

		data_scribe_markup_c::attribute_c const * attribute = nullptr;

		orientation_e orientation = orientation_e_vertical;
		attribute = node->find_attribute( "orientation" );
		if ( attribute )
		{
			if ( attribute->get_value() == "horizontal" )
			{
				orientation = orientation_e_horizontal;
			}
		}
		set_orientation( orientation );

		mode_e mode = mode_e_scroller;
		attribute = node->find_attribute( "mode" );
		if ( attribute )
		{
			if ( attribute->get_value() == "scrubber" )
			{
				mode = mode_e_scrubber;
			}
		}
		set_mode( mode );
		...
		_fixed_thickness = 10.0f;
		attribute = node->find_attribute( "fixed_thickness" );
		if ( attribute )
		{
			ops::convert_string8_to_float32( attribute->get_value(), _fixed_thickness );
		}
	...
	menu_control_scroll_c::orientation_e menu_control_scroll_c::get_orientation() const
	{
		return _orientation;
	}

	void_c menu_control_scroll_c::set_orientation( orientation_e value )
	{
		_orientation = value;
		update_transform_and_layout();
	}

	menu_control_scroll_c::mode_e menu_control_scroll_c::get_mode() const
	{
		return _mode;
	}

	void_c menu_control_scroll_c::set_mode( mode_e value )
	{
		_mode = value;
		_page_size = 0.0;
		_line_size = 0.0;
	...
	void_c menu_control_scroll_c::update_visibility( menu_visibility_mode_e value )
	{
	...
	void_c menu_control_scroll_c::set_value_range_and_page_size( float64_c value_minimum, float64_c value_maximum, float64_c page_size )
	{
	...
	float64_c menu_control_scroll_c::get_page_size() const
	{
		return _page_size;
	}

	void_c menu_control_scroll_c::set_page_size( float64_c value )
	{
		_page_size = value;
	}

	float64_c menu_control_scroll_c::get_line_size() const
	{
		return _line_size;
	}

	void_c menu_control_scroll_c::set_line_size( float64_c value )
	{
		_line_size = value;
	}

	float64_c menu_control_scroll_c::get_value_minimum() const
	{
		return _value_minimum;
	}

	void_c menu_control_scroll_c::set_value_minimum( float64_c value )
	{
		_value_minimum = value;
		update_transform_and_layout();
	}

	float64_c menu_control_scroll_c::get_value_maximum() const
	{
		return _value_maximum;
	}

	void_c menu_control_scroll_c::set_value_maximum( float64_c value )
	{
		_value_maximum = value;
		update_transform_and_layout();
	}

	float64_c menu_control_scroll_c::get_value_increment() const
	{
		return _value_increment;
	}

	void_c menu_control_scroll_c::set_value_increment( float64_c value )
	{
	...
	float64_c menu_control_scroll_c::get_value() const
	{
		return _value;
	}

	void_c menu_control_scroll_c::set_value( float64_c value )
	{
	...
	float64_c menu_control_scroll_c::get_value_smoothed() const
	{
		return _value_smoothed;
	}

	float64_c menu_control_scroll_c::get_scrub_speed_ease_in() const
	{
		return _scrub_speed_ease_in;
	}

	void_c menu_control_scroll_c::set_scrub_speed_ease_in( float64_c value )
	{
		_scrub_speed_ease_in = ops::math_clamp( value, 0.5, 10.0 );
	}

	float64_c menu_control_scroll_c::get_scrub_speed() const
	{
		return _scrub_speed;
	}

	void_c menu_control_scroll_c::set_scrub_speed( float64_c value )
	{
		if ( value < 0.0 )
		{
			value = 0.0;
	...
	float32_c menu_control_scroll_c::get_fixed_thickness() const
	{
		return _fixed_thickness;
	}

	void_c menu_control_scroll_c::set_fixed_thickness( float32_c value )
	{
		_fixed_thickness = value;
		
	}

	float32_c menu_control_scroll_c::get_fixed_grip_length() const
	{
		return _fixed_grip_length;
	}

	void_c menu_control_scroll_c::set_fixed_grip_length( float32_c value )
	{
		if ( value < 1.0 )
		{
			value = 1.0;
	...
	void_c menu_control_scroll_c::inject_mouse_wheel_input( float32_c value )
	{
