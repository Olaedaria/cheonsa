...
namespace cheonsa
{
	...
	void_c physics_make_btTransform_from_space_transform( transform3d_c const & in_transform, btMatrix3x3 & out_basis, btVector3 & out_origin )
	{
	...
	void_c physics_make_space_transform_from_btTransform( btMatrix3x3 const & in_basis, btVector3 const & in_position, transform3d_c & out_transform )
	{
		...
		out_transform.rotation = ops::rotation_quaternion32_from_basis_matrix32x3x3( out_basis );
