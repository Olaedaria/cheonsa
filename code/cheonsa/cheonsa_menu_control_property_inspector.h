...
namespace cheonsa
{
	...
	public:
		...
		struct property_field_c
		{
			...
			menu_control_scroll_bar_i * scroll; // might be a horizontal scroll bar or a horizontal scrub bar, for editing number values that are constrained to a certain range.
