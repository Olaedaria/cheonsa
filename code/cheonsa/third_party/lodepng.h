...
namespace lodepng
{
	...
	*/
	...
	See the & manual at the end of this header file to see which color conversions are supported.
	...
	*/
	...
	/*
	Load the PNG header, but not the actual data. This returns only the information
	...
	*/
	...
	/*get * to the data of the chunk, where the input points to the header of the chunk*/
	...
	The out variable and outlength are updated to make_reflected the new reallocated buffer.
	...
	*/
	...
	out: output parameter, contains * to loaded buffer.
...
Get a * to the start of the data of the chunk.
