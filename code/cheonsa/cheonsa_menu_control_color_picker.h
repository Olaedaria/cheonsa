...
namespace cheonsa
{
	...
	protected:
		...
		menu_control_scroll_bar_x_c * _h_scroll_bar;
		menu_control_text_c * _h_text;

		menu_control_scroll_bar_x_c * _s_scroll_bar;
		menu_control_text_c * _s_text;

		menu_control_scroll_bar_x_c * _v_scroll_bar;
		menu_control_text_c * _v_text;

		menu_control_scroll_bar_x_c * _r_scroll_bar;
		menu_control_text_c * _r_text;

		menu_control_scroll_bar_x_c * _g_scroll_bar;
		menu_control_text_c * _g_text;

		menu_control_scroll_bar_x_c * _b_scroll_bar;
		menu_control_text_c * _b_text;

		menu_control_scroll_bar_x_c * _a_scroll_bar;
		...
		void_c _handle_slider_on_value_changed( menu_control_scroll_bar_i * slider );
