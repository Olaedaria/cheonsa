...
namespace cheonsa
{
	...
	void_c menu_control_color_picker_c::_sync_control_values()
	{
		...
		if ( _b_text != nullptr )
		{
			...
			_b_text->set_plain_text( string16_c( value_string ) );
		}
		...
		if ( _rgba_hex_text != nullptr )
		{
			...
			_rgba_hex_text->set_plain_text( string16_c( value_string ) );
		}
	}
	...
	{
		string16_c text_value = text->get_plain_text();
		if ( text == _h_text )
		{
		...
		, _rgba_hex_text( nullptr )
	{
		...
		_s_text->set_text_filter_mode( menu_text_filter_mode_e_numeric_real );
		...
		_v_text->set_text_filter_mode( menu_text_filter_mode_e_numeric_real );
		...
		_r_text->set_text_filter_mode( menu_text_filter_mode_e_numeric_real );
		...
		_g_text->set_text_filter_mode( menu_text_filter_mode_e_numeric_real );
		...
		_b_text->set_text_filter_mode( menu_text_filter_mode_e_numeric_real );
		...
		_a_text->set_text_filter_mode( menu_text_filter_mode_e_numeric_real );
		...
		_rgba_hex_text->set_text_filter_mode( menu_text_filter_mode_e_none );
		...
		_rgba_float_text->set_text_filter_mode( menu_text_filter_mode_e_none );
