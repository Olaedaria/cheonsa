...
namespace cheonsa
{
	...
	public:
		...
		void_c open(); // opens this stream for reading and writing and automatically resizes internal array as needed.
		void_c open_static( void_c const * data, sint32_c data_size ); // wraps data buffer for reading and writing, size is fixed.
		void_c close(); // closes this stream and frees any resources allocated by this stream.
