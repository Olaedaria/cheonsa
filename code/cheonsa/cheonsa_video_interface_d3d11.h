...
namespace cheonsa
{
	...
	public:
		...
		virtual video_texture_c * create_texture( video_texture_format_e texture_format, sint32_c width, sint32_c height, sint32_c msaa_count, sint32_c array_slice_count, void_c * top_mip_level_data, sint32_c top_mip_level_data_size, boolean_c set_data_enable, boolean_c get_data_enable, boolean_c target_enable, boolean_c mip_enable ) override;
